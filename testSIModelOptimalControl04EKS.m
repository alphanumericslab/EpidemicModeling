...
human_npi_cost_factor = 0.1; % [0, 1]: 0 neglects NPI cost and 1 neglects human factor!

for k = 120 : NumGeoLocations%index_ : index_%240 %122 : 125%225 %1 : NumGeoLocations
    k
    ...
    I0 = NewCasesSmoothed(1); % initial number of cases
    ...
    if(TWO_ROUND_TRAINING)
        ...
        I0 = round(N_population * S_SMOOTH(2, 1));
        ...
        y_pred_lasso2 = x_data_train * coef_2 + coef0_2;
    ...
    if(0)
        ...
        for kk = 1 : num_random_input_monte_carlo_runs
            ...
            for t = 1 : length(NewCasesSmoothedNormalized)
                for jj = 1 : NumNPI
