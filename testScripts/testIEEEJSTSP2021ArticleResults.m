...
START_DATE_TRAIN = "2020-03-04"; % start time
START_DATE_REGRESSION = "2020-03-04"; % start NPI model regression date
END_DATE_TRAIN = "2020-12-03"; % end time
END_DATE_PREDICT_PRESCRIBE = "2021-03-04"; % end time
MaxLookAheadDays = 60;
...
ForecastQualityAssessment(npi_weights, human_npi_cost_factor, START_DATE_TRAIN, END_DATE_TRAIN, START_DATE_REGRESSION, END_DATE_PREDICT_PRESCRIBE, MaxLookAheadDays, LATEST_DATA_FILE, GEO_FILE, POPULATION_FILE, INCLUDED_IP, IP_MINS, IP_MAXES, TRAINED_MODEL_PARAMS_FILE);
